...
#Взлет
navigate(x=0, y=0, z=0.75, speed=0.2, frame_id='body', auto_arm=True)
rospy.sleep(15)

#Летим в первую точку
navigate(x=0.295, y=0.295, z=0.75, speed=0.2, frame_id='aruco_map')
rospy.sleep(10)
...
navigate(x=0.885, y=0.295, z=0.75, speed=0.2, frame_id='aruco_map')
rospy.sleep(10)
check = '2'
rospy.sleep(2)
check = '0'
...
navigate(x=0.295, y=0.885, z=0.75, speed=0.2, frame_id='aruco_map')
rospy.sleep(10)
check = '3'
rospy.sleep(2)
check = '0'
...
navigate(x=0.885, y=0.885, z=0.75, speed=0.2, frame_id='aruco_map')
rospy.sleep(10)
check = '4'
rospy.sleep(2)
check = '0'
...
navigate(x=0.295, y=1.475, z=0.75, speed=0.2, frame_id='aruco_map')
rospy.sleep(10)
check = '5'
rospy.sleep(2)
check = '0'
...
navigate(x=0.885, y=1.475, z=0.75, speed=0.2, frame_id='aruco_map')
rospy.sleep(10)
check = '6'
rospy.sleep(2)
check = '0'
...
navigate(x=0.295, y=2.065, z=0.75, speed=0.2, frame_id='aruco_map')
rospy.sleep(10)
check = '7'
rospy.sleep(2)
check = '0'
...
navigate(x=0.885, y=2.065, z=0.75, speed=0.2, frame_id='aruco_map')
rospy.sleep(10)
check = '8'
rospy.sleep(2)
check = '0'
...
navigate(x=0.59, y=2.655, z=0.75, speed=0.2, frame_id='aruco_map')
rospy.sleep(10)
check = '9'
rospy.sleep(2)
check = '0'
...
navigate(x=0, y=0, z=0.75, speed=0.2, frame_id='aruco_map')
rospy.sleep(18)
...
for i in list(SUSPECTS.keys()):
    coord = PATIENTS[i]
    navigate(x=coord[0], y=coord[1], z=0.75, speed=0.2, frame_id='aruco_map')
    rospy.sleep(10)
    check = i
    rospy.sleep(1)
    check = "0"
